export const COMPLIMENT_CYCLE_TIME = 432000;
// export const COMPLIMENT_CYCLE_TIME = 5000;
export const GOOGLE_CALENDAR_API_KEY = "";
export const COUNTRY = "usa";
export const WTTRIN_API = "https://wttr.in/?format=4";
export const HOLIDAY_MONTH_INCLUDE = 3;
